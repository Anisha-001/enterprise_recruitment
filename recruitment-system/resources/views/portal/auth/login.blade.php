...
<div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white py-8 px-4 shadow-xl border border-gray-100 rounded-xl sm:px-10 glass-card">
            <form class="space-y-6" action="{{ route('candidate.login') }}" method="POST">
                @csrf
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('candidate.forgot-password') }}" class="font-medium text-brand-600 hover:text-brand-500">
